...
public class DiscoveryRequest : MessageBase
{
    ...
    public string clientName = "NewPlayer";
}
...
public class NewNetworkDiscovery : NetworkDiscoveryBase<DiscoveryRequest, DiscoveryResponse>
{
    ...
    public NewServerFoundUnityEvent OnServerFound;
    ...
    {
        return new DiscoveryResponse() { hostName = "Unity", serverName = "Public Game" };
    }
    ...
    {
        return new DiscoveryRequest() { clientName = "Player_Alice" };
    }
